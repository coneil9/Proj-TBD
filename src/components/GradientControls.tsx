  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-xs uppercase tracking-[0.3em] text-cyan-300 font-semibold">Phase 4</p>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="rounded-2xl border border-white/10 bg-slate-900/70 p-4">
          ...
          <p className="text-xs text-slate-400 mt-1">Linear / Radial toggle coming next.</p>
          ...
          {state.stops.map((stop) => (
            ...
            >
              ...
              <div className="flex items-center gap-2 text-[11px] text-slate-400">
                <button
                  className="px-2 py-1 rounded-lg border border-white/10 hover:border-red-400/60 hover:text-red-200 transition"
                  type="button"
